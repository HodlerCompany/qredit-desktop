    ...
    if (arg.action === 'detect') {
      ...
      if (!ledgercomm) {
        ...
        try {
          ...
          const result = {
            connected: false,
            message: 'Cannot connect to Qredit application'
          }
          event.returnValue = result
        }
      }
  ...
  template = [
      ...
      submenu: [
        {
          ...
          click: () => openAboutWindow({
            ...
            copyright: 'Copyright (c) 2018 Qredit',
            homepage: 'https://qredit.io/',
            bug_report_url: 'https://github.com/HodlerCompany/qredit-desktop/issues'
          })
        },
        { type: 'separator' },
    ...
    },
    {
      ...
      submenu: [
        {
          label: 'Learn More',
          click () { require('electron').shell.openExternal('https://qredit.io') }
        },
